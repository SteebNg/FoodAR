...
public class UnityPlayerGameActivity extends GameActivity implements IUnityPlayerLifecycleEvents, IUnityPermissionRequestSupport, IUnityPlayerSupport
{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        if (intent != null) {
            String receivedFoodId = intent.getStringExtra("result");
    ...
    public void ExitUnityActivity() {
        Log.d("UnityPlugin", "Calling finish() to return to previous activity.");
            ...
            public void run() {
                new android.os.Handler().postDelayed(
                        new Runnable() {
                            @Override
                            public void run() {
                                Log.d("UnityPlugin", "DelayFinished.");
                                finish();
                            }
                        }, 750);
